  ...
  <section class="product-container">
        <div class="program">
            ...
            <h4>Over  <?php echo $pr['No_Of_Days']?> day(s) period</h4>
             <hr>
            <div class="pr_price"><p> <?php echo $pr['Price']; ?> EG </p></div>
            <button>View Details</button>
            <button onclick="AddToCart('<?php echo $pr['Program_Number'] ?>','<?php echo $pr['Price'] ?>')">Add to Cart</button>
